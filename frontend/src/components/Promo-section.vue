  ...
  <div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
    <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
      <div class="sm:max-w-lg">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Effortless style. Student prices</h1>
        <p class="mt-4 text-xl text-gray-500">You favourite brands and minimalist picks shouldn't cost a semeester's rent. Shop the latest drops from fellow students and refresh you look for less.</p>
      </div>
      <div>
        <div class="mt-10">
          ...
          <a href="#" class="inline-block rounded-md border border-transparent bg-uom-purple px-8 py-3 text-center font-medium text-white hover:bg-uom-purple-light">Shop Collection</a>
        </div>
      </div>
    </div>
  </div>
